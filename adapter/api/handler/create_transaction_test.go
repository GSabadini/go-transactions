...
func TestCreateTransactionHandler_Handle(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantBody:       `{"id":"aef3836b-5ea4-4890-80ad-e13337ccf47f","account_id":"92c82203-cdba-4932-9860-bce2e6140267","operation":{"id":"fd426041-0648-40f6-9d04-5284295c5095","description":"COMPRA A VISTA","type":"DEBIT"},"amount":-10.74,"created_at":"2020-10-16T17:50:39Z"}`,
		...
		},
		{
			...
			rawPayload:     []byte(`{"account_id": "92c82203-cdba-4932-9860-bce2e6140267","operation_id": "invalid","amount": 10.74}`),
		...
		},
		{
			...
			rawPayload:     []byte(`{"account_id": "92c82203-cdba-4932-9860-bce2e6140267","operation_id": "fd426041-0648-40f6-9d04-5284295c509","amount": -10.74}`),
